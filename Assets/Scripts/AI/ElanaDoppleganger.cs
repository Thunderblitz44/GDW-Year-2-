...
public class ElanaDoppleganger : Enemy
{
    ...
    [SerializeField] float wolfLerpSpeed = 3;
    [SerializeField] float minMeleeAttackTime = 1;
    [SerializeField] float maxMeleeAttackTime = 5;
    [SerializeField] float minMeleeCooldown = 1;
    [SerializeField] float maxMeleeCooldown = 3;
    ...
    [SerializeField] float minRangedCooldown = 1f;
    [SerializeField] float maxRangedCooldown = 3f;
    ...
    [SerializeField] float dodgeAwayDelay = 2f;
    ...
    [SerializeField] float maxTornadoCooldown = 5f;
    ...
    [SerializeField] float meleeStopDist = 2f;
    [SerializeField] float rangedStopDist = 4f;
    [SerializeField] float tooCloseDist = 1f;
