...
public class GolemRangerLights : MonoBehaviour
{
    public Transform[] bonesToDraw; // Assign bones to this array in the inspector
      ...
      private float lineScale = 5.0f; // Scale factor for the line renderers
      ...
      void Update()
      {
          ...
          for (int i = 0; i < lineRenderers.Length; i++)
          {
              if (lineRenderers[i] != null && bonesToDraw[i] != null && bonesToDraw[i + 1] != null)
              {
                  ...
                  lineRenderers[i].startWidth = 0.05f * lineScale;
                  lineRenderers[i].endWidth = 0.05f * lineScale;
              }
          }
      }
      ...
      LineRenderer CreateLineRenderer(Transform parent)
      {
          ...
          lineRenderer.startWidth = 0.05f * lineScale;
          lineRenderer.endWidth = 0.05f * lineScale;
          return lineRenderer;
      }
}
